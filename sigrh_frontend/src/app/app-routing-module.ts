...
const routes: Routes = [
  ...
  },
  {
    ...
    loadChildren: () => import('./features/mon-espace/mon-espace.module').then(m => m.MonEspaceModule)
  },
  {
    path: '',
    ...
    children: [
      ...
      {
        path: 'profils',
        loadChildren: () => import('./features/profils/profils.module').then(m => m.ProfilsModule)
      },
