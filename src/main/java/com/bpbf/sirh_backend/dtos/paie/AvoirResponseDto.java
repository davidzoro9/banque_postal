...
public class AvoirResponseDto {
    ...
    private BigDecimal amount;                // Montant Total / Initial
    private BigDecimal montantRestant;        // Reste
    private BigDecimal montantVerse;          // Mt. Versé
    private BigDecimal versementMensuel;      // Vers. Mens.
    private Integer echeance;
    private LocalDate dateDebut;
    private LocalDate dateEcheance;
    private String statut;
    @Builder.Default
    private List<AvoirVersementDto> versements = new ArrayList<>();
}
