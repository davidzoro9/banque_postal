...
const routes: Routes = [
  ...
  { path: 'conges/soldes',                   component: CongesListComponent },
  { path: 'conges/planning',                 component: CongesListComponent },
  { path: 'conges/feries',                   component: CongesListComponent },
  { path: 'conges/parametrage',              component: CongesListComponent },
