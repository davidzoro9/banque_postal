...
export class GrhOverviewComponent implements OnInit {
  ...
  kpis = [
    { label: 'Effectif total',          value: '248', icon: 'badge',          color: '#163059', sub: '+3 ce mois' },
    { label: 'Congés en attente',       value: '12',  icon: 'event_available', color: '#FFB300', sub: 'À valider' },
    { label: 'Contrats à renouveler',   value: '3',   icon: 'autorenew',      color: '#E53935', sub: 'Dans 30 jours' }
  ];

  quickActions = [
    { label: 'Nouvel employé',  icon: 'person_add',     route: '/grh/employes/nouveau', color: '#163059' },
    { label: 'Valider congés',  icon: 'event_available', route: '/grh/conges',           color: '#FFB300' },
    { label: 'Organigramme',    icon: 'account_tree',    route: '/grh/organigramme',     color: '#1565C0' }
  ];
