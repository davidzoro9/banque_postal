...
@Component({
  ...
  template: `
    <div style="padding: 24px; max-width: 1200px; margin: 0 auto;">
      <h2 style="color: #163059; margin-bottom: 16px;">Historique des Bulletins de Paie</h2>
      <mat-card style="border-radius: 12px; padding: 20px;">
        ...
        <table style="width: 100%; border-collapse: collapse; margin-top: 16px;">
          ...
          <tr style="border-bottom: 1px solid #f1f5f9;">
            ...
            <td style="padding: 10px; font-weight: 600; color: #163059;">2 600 000 FCFA</td>
          ...
          <tr style="border-bottom: 1px solid #f1f5f9;">
            ...
            <td style="padding: 10px;">4</td>
            <td style="padding: 10px; font-weight: 600; color: #163059;">2 550 000 FCFA</td>
